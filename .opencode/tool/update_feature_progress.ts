...
export default tool({
  ...
  execute: async ({ featureId, message }) => {
    const response = await fetch("https://launchpulse.ai/api/project/create-a-professional/features/progress", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        projectId: "create-a-professional",
        token: "lp_createap_69700119d0164c76",
        featureId: featureId,
        passes: true,
